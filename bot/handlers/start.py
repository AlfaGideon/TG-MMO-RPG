...
FACTION_LORE_CIRCLE = (
    ...
    "Их отношения замкнуты в <b>кольцо вражды</b>: помощь одной силе "
    "неминуемо злит её соперника. Невозможно быть своим для всех — "
    "каждый выбор — это чья-то потеря.\n\n"
    "🔁 <b>Круговая вражда:</b>\n\n"
    "   🛡 Стража  →  ненавидит  💰 Гильдию\n"
    "   💰 Гильдия  →  ненавидит  🌑 Культ\n"
    "   🌑 Культ   →  ненавидит  🛡 Стражу\n\n"
    "Стража, Гильдия и Культ связаны кольцом: каждая сила ненавидит "
    "следующую, и этот круг бесконечен. Помочь Страже — значит "
    "навлечь гнев Гильдии. Помочь Гильдии — разозлить Культ. "
    "Помочь Культу — обозлить Стражу.\n\n"
    "⚜️ <b>Орден Рассвета</b> стоит вне круга, но его заклятый враг — "
    "Культ. Рыцари Рассвета и Стража Погоста делят общего врага, "
    "и потому их союз крепок.\n\n"
    "<b>Схема:</b>\n"
    "<code>      🛡 Стража\n"
    "     ↗        ↘\n"
    "  🌑 Культ  ←  💰 Гильдия\n"
...
FACTION_LORE = {
    "guard": (
        ...
        "⚔️ <b>Круг вражды:</b> Стража ненавидит <b>Гильдию падальщиков</b> — "
        "мародёров, которые грабят могилы и оскверняют павших. То, ради чего "
        "стражники положили жизни, для падальщиков — лишь нажива. "
        "Но вражда идёт по кругу: помогая Страже, ты злишь Гильдию, "
        "а Гильдия — союзник Культа, врага Стражи.\n\n"
    ...
    "scavengers": (
        ...
        "⚔️ <b>Круг вражды:</b> Гильдия ненавидит <b>Культ Пожирателя</b> — "
        "культисты ускоряют катаклизмы, а Гильдия теряет на хаосе: "
        "рушатся торговые пути, гибнут покупатели, исчезают товары. "
        "Бизнес любит порядок. Но помогая Гильдии, ты злишь Культ, "
        "а Культ — враг Стражи, которая и так ненавидит Гильдию.\n\n"
    ...
    "cult": (
        ...
        "⚔️ <b>Круг вражды:</b> Культ ненавидит <b>Стражу Погоста</b> — "
        "стражники оттягивают неизбежное, строят стены, сжигают нежить. "
        "Культ видит в них слепцов, что цепляются за умирающий мир. "
        "Но помогая Культу, ты злишь Стражу, а Стража — враг Гильдии, "
        "которая и так ненавидит Культ. Круг замыкается.\n\n"
        "⚔️ <b>Второй враг:</b> Орден Рассвета ведёт с Культом священную "
        "войну. Культ ненавидит свет — а Орден несёт его в самую тьму.\n\n"
    ...
    "order": (
        ...
        "канули бы в бездну.\n\n"
        "⚔️ <b>Вне круга:</b> Орден не входит в кольцо вражды Стража→Гильдия→Культ, "
        "но его заклятый враг — <b>Культ Пожирателя</b>. Это не просто "
        "вражда — это священная война. Культ торопит конец света, "
        "Орден — не даёт ему наступить. Две стороны одной медали, "
        "и между ними нет мира.\n\n"
        "🤝 <b>Союз:</b> Стража Погоста. Стражники держат стены, "
        "рыцари несут свет — вместе они создают островки порядка "
        "в мире, что стремится распасться. Общий враг объединяет крепче "
        "любого договора."
    ),
}
