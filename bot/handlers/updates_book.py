...
SAMPLE_UPDATES = [
    {
        "title": "v1.9 — Очки характеристик и баланс фракций",
        "short": "С уровня даются очки характеристик — вкладывай их сам. Стартовые деньги фракции зависят от её населённости.",
        "full": [
            "• Новый уровень: +3 очка характеристик (круглые уровни — больше)",
            "• Распределение в 🧙 Профиль → 🎯 Очки: кнопки ➕/➖ под каждым статом",
            "• Очко Выносливости = +10 ❤️ HP, Интеллекта = +5 💙 MP",
            "• Вложенные очки можно снимать и перекладывать, база неизменна",
            "• Стартовые деньги — только от фракции: у редкой фракции выдача больше (до ×2), у перенаселённой — меньше (до ×0.5)",
            "• В топе игроков теперь отображаются фракция и имя, а не тег",
            "• Карта в пути такая же цветная, как в разделе «Карта», с кнопками масштаба ➕/➖",
        ]
    },
    {
