...
Твой путь продолжается. Тьма всё ещё сгущается над миром, и только ты решаешь, какой след оставишь в этой истории.

Крепости ждут своих защитников, а подземелья — своих первооткрывателей.

<i>Вернись в бой и прославь своё имя!</i>
"""
