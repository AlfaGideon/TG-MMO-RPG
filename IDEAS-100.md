...
| 3. Вход игроку в боте | 25 | № 36–47, 50, 51, 52, 54, 55, 56, 57 | № 48, 49, 53, 59 | подсистемы без единого вызова из `bot/handlers/` |
...
**Сделано на 2026-08-14: 39 пунктов закрыто полностью, 10 частично, 1 снят как задача-фантом (№ 58).**
Закрыты: № 1, 2, 3, 6, 7, 8, 9, 10, 36–47, 50, 51, 52, 54, 55, 56, 57, 61, 62, 63, 77, 78, 85, 88, 89, 95, 100.
Частично: № 35, 48, 49, 53, 59, 64, 65, 66, 72, 92 (остаток описан внутри каждого пункта).
