...
**Сделано на 2026-08-14: 83 пункта закрыто полностью, 1 частично, 1 снят как задача-фантом (№ 58).**
Закрыты: № 1, 2, 3, 6–57 (кроме 4, 5, 20, 58), 61–66, 72, 77–85, 87–95, 98, 100.
**Паритет: 49 из 49 механик в обоих стеках. Раздел 2 (перенос `core/` → `engine/`) закрыт полностью** — теперь каждая серверная механика доступна и на GitHub Pages.
