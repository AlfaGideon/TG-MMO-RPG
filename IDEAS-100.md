...
| 2. Паритет `core/` → `engine/` | 25 | № 11, 12, 16–19, 21–25, 32–35 | — | 10 серверных подсистем без браузерного близнеца |
...
**Сделано на 2026-08-14: 74 пункта закрыто полностью, 1 частично, 1 снят как задача-фантом (№ 58).**
Закрыты: № 1, 2, 3, 6, 7, 8, 9, 10, 11, 12, 16–19, 21–25, 32–35, 36–57 (кроме 58), 61–66, 72, 77–85, 87–95, 98, 100.
**Паритет: 41 из 41 механик в обоих стеках, долгов в реестре нет.**
