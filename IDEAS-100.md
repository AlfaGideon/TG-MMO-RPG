...
| 6. Баги и долги из аудита | 12 | № 77, 78, 79, 80, 85, 88 | — | долги A/B/C, сироты аукциона, секрет, колбэки, квесты |
| 7. Трёхвалютная экономика | 6 | № 89–94 (все) | — | **долг закрыт: паритет 28/28** |
| 8. Документация | 6 | № 95, 98, 100 | — | устаревшие цифры и списки |
| **Итого** | **100** | **55** | **1** | — |

**Сделано на 2026-08-14: 55 пунктов закрыто полностью, 1 частично, 1 снят как задача-фантом (№ 58).**
Закрыты: № 1, 2, 3, 6, 7, 8, 9, 10, 35, 36–57 (кроме 58), 61–66, 72, 77–80, 85, 88–94, 95, 98, 100.
