...
def cell_form(ctx, key):
    ...
    Отдельного окна нет: форма живёт рядом с сеткой, поэтому карта не
    перекрывается, а выбранная клетка подсвечивается прямо на ней.
    """
...
<div class="dock-empty">
  ...
  🖱 Кликни любую клетку карты слева — её свойства откроются здесь:
  название, описание, тайл, проходимость, моб, NPC и сундук.
</div>
"""
