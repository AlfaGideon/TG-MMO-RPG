...
Пороги кармы берутся из `core/karma.py` — единственного источника правды
(раньше ±150 были зашиты здесь отдельной копией, и при смене порогов
диалоги отстали бы от системы кармы).
"""
...
def generate_reactive_dialogue(character: Character, npc_name: str, npc_type: str, world_context: dict) -> str:
    ...
    elif karma <= core_karma.DEFILED_KARMA:
        return f"{prefix}:\n— Отойди от меня, осквернитель... Твои руки пахнут разрытыми могилами."
    elif karma >= core_karma.PIOUS_KARMA:
