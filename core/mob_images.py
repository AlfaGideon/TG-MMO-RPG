...
MOB_IMAGES = {
    ...
    "Вьюжный призрак": "blizzard_ghost.jpg",
    "Мёрзлый зомби": "frozen_zombie.jpg",
    "Снежный волк": "snow_wolf.jpg",
    "Северный упырь": "northern_ghoul.jpg",
    "Пепельный хищник": "ash_predator.jpg",
    "Зольный дух": "cinder_spirit.jpg",
    "Обожжённый скелет": "burned_skeleton.jpg",
    "Пепельный страж": "ash_guardian.jpg",
    "Болотный упырь": "swamp_ghoul.jpg",
    "Цапля-мертвяк": "undead_heron.jpg",
    "Гнилой латник": "rotten_knight.jpg",
