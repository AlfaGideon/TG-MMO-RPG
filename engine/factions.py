...
FACTIONS = {
    ...
    "order": ("⚜️", "Орден Рассвета",
              "Свет не просит разрешения — он просто приходит.", "cult"),
}
...
DEEDS = {
    "undead_slain": {"guard": 2, "cult": -2},        # культ нежить защищает
    "beast_slain": {"guard": 1},                     # убил зверя
    "grave_looted": {"scavengers": 4, "guard": -2},  # стража порядок бережёт
