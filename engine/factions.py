...
что-то значит.
  ...
  ⚜️ **Орден Рассвета** — свет. Истребляет нежить, хранит реликвии и
     старые клятвы; его заклятый враг — Культ.
...
# Вражда идёт по кругу: стража злит падальщиков, падальщики — культ,
# культ — стражу; у ордена личный враг — культ. Никаких взаимных пар:
# иначе выбор сводился бы к «одна сторона против другой», а не к кольцу
# интересов (см. tests/test_factions.py — «фракции связаны по кругу»).
FACTIONS = {
