...
DEEDS = {
    ...
    # Дельты зверя — тоже 2, а не 1: при SPITE=0.5 и нижней границе
    # max(1, …) каждая +1 гасится −1 у соперника, и «убил зверя» давал
    # ровно ноль репутации (бой вообще не влиял на репутацию).
    "beast_slain": {"guard": 2, "order": 2, "cult": 2, "scavengers": 2},               # убил зверя
