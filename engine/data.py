...
LOCATIONS = [
    ...
    # Угловые замки 25x25 для старта (по углам мировой сетки)
    ...
    # Промежуточные локации между углами
    ("Тракт между Рассветом и Тенями", "Дорога сквозь болота северного края.", "dangerous", 3),
    ("Тракт между Рассветом и Глубинами", "Западный тракт вдоль скал.", "dangerous", 3),
    ("Тракт между Тенями и Пеплом", "Восточный путь через пепельные земли.", "dangerous", 3),
    ("Тракт между Глубинами и Пеплом", "Южная дорога через пустоши.", "dangerous", 3),
]
